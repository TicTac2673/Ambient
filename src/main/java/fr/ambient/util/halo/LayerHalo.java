...
public class LayerHalo implements LayerRenderer<AbstractClientPlayer> {
    ...
    public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
        ImageObject location = ProtectedLaunch.CUSTOM_CAPE.getHaloLocation(entitylivingbaseIn).getNow(null);
        ...
        RenderUtil.drawImage(location.textureID, (int) (-scalePixels / 2), (int) (-scalePixels / 2), (int) scalePixels, (int) scalePixels);
